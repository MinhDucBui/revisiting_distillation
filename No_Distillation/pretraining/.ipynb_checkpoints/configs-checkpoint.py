...
def update_kwargs(**kwargs):
    ...
    # Create a new set of keyword arguments
    new_kwargs = kwargs.copy()
    
    # Remove a specific key (e.g., 'age')
    key_to_remove = 'position_embedding_type'
    if key_to_remove in new_kwargs:
        del new_kwargs[key_to_remove]
    return new_kwargs

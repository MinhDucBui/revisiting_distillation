...
def prepare_model_and_optimizer(args):
    ...
    # HACK: Initialize from 12 layer model
    from transformers import BertModel
    #bert_12_layer = BertModel.from_pretrained("bert-base-uncased")
    #for name_teacher, param_teacher in bert_12_layer.named_parameters():
    #    for name_student, param_student in model.network.named_parameters():
    #        if "bert." + name_teacher == name_student:
    #            print("Initialize student layer from teacher: {}".format(name_teacher, name_student))
    #            param_student = param_teacher#.copy()
    #            break
    #del bert_12_layer
